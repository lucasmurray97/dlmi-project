...
def get_args_parser():
    ...
    parser.add_argument('--patch_size', default=14, type=int, help="""Size in pixels
...
def train_dino(args):
    ...
    h5_paths = [
        ...
        os.path.join(args.data_path, "val.h5"),
        os.path.join(args.data_path, "test.h5"),
    ]
    dataset = CombinedH5UnlabeledDataset(h5_paths, transform=transform)
